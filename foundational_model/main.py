...
from foundational_model.models import ViTMAE, SingleChannelConv
...
model_config = ViTMAE.LightningConfig(
    SingleChannelConv.SingleChannelAE_CNN_Config(
        ...
        reduction_ratios = [1, 1, 1, 1, 0.5, 1, 1, 1, 1, 0.5, 1, 1, 1, 1, 0.5, 1, 1, 1, 1, 0.5, 1, 1],
        shortcut = True,


        losses = ["temporal", "spectral"],
        loss_weights=[0, 1],
    ),
...
model = SingleChannelConv.SingleChannelAE_CNN_Lightning(model_config)
