...
from foundational_model.downstream_models import model


log = logging.getLogger(__name__)


@hydra.main(version_base=None, config_path="../config", config_name="base_downstream")
def main(config: DictConfig):
    ...
    #use a wandb logger
    wandb.init(project="emg2qwerty_downstream")
    wandb_logger = pl.loggers.WandbLogger(project="emg2qwerty_downstream",
